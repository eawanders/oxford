...
create_balance_table <- function(data,
    ...
    clean_names <- c(
        ...
        "X" = "Female",
        "profile_education_level_recode...." = "Education level (High)",
        "X.1" = "Low",
        "X.2" = "Medium",
...
```{r render-balance-tables, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
# === Render Balance Tables ===
# Create and render balance tables for each treatment variable
treatment_names <- list(
    ai_treatment = "AI Treatment Group",
    label_treatment = "Label Treatment Group"
)

for (i in seq_along(treatment_vars)) {
    var_name <- treatment_vars[i]
    pretty_name <- treatment_names[[var_name]]

    caption <- paste0("Balance Table of Covariates by ", pretty_name)

    # Define the desired output names for the columns for this specific table
